...
console.log(typeof myDate);
  //  ************************Date Methods***********************
// let MyCreatedDate = new Date ("2025-01-20") // use date as YY/MM/DD
// let MyCreatedDate = new Date(2022,1,20)  //only for a date
// let MyCreatedDate = new Date(2022 ,3,1,5,3) //date and time both
// let MyCreatedDate = new Date ("11-20-2002")  // MM/DD/YY  
